# copied from makecite.parsers
# modify parse_py_module to avoid 'path too long for Windows' when parsing .ipynb files
from os import path
...
def parse_py_module(filename_or_str):
    ...
    packages : set
        ...
        file.
    """
    if len(filename_or_str) <=260: # avoid 'path too long for Windows' error
